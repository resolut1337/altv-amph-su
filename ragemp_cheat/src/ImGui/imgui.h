...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginChildq(ImGuiID id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
    ...
    IMGUI_API bool          Checkbox(const char* label, bool* v, const char* TextDisc = "");
   ...
   // IMGUI_API  bool InputText(const char* label, char* buf, size_t buf_size, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* user_data, ImVec2 size_arg = ImVec2(0, 0));
    IMGUI_API bool          InputText(const char* label, char* buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL, ImVec2 size_arg = ImVec2(0, 0));
