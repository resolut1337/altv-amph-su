...
struct key_state
{
    ImVec4 background, text, combo_color;
    bool active = false;
    bool hovered = false;
    float alpha = 0.f;
};
...
bool ImGui::Keybind(const char* label, int* key, bool show_label)
{
    ...
    GetWindowDrawList()->AddShadowRect(clickable.Min + ImVec2(0, 0), clickable.Max - ImVec2(0, 0), GetColorU32(it_anim->second.combo_color), 20, ImVec2(0, 0), 15, 30);
...
{
    SetCursorPos(GetCursorPos() + ImVec2(GetContentRegionMax().x - 303, 0));
...
struct tab_state
{
    ImVec4 image, shadow, text, background;
    float shadow_offset;
};
...
bool ImGui::Tab(bool selected, const char* icon, const char* label, const char* hint, const ImVec2& size_arg, const char* number)
{
    ...
    const ImRect bb(pos - ImVec2(6.5, 10), pos + size + ImVec2(6.5, 10));

    const ImRect image_bb(pos + ImVec2(20, (size_arg.y - 40) / 2), pos + ImVec2(25, (size_arg.y + 40) / 2));
    ...
    it_anim->second.image = ImLerp(it_anim->second.image, selected || hovered ? ImVec4(c::menu_sett::menu_color_swither.Value.x, c::menu_sett::menu_color_swither.Value.y, c::menu_sett::menu_color_swither.Value.z, 0.5f) : c::text::text, g.IO.DeltaTime * 12.f);
    ...
    it_anim->second.background = ImLerp(it_anim->second.background, selected || hovered ? c::child::outline_background : hovered ? c::child::outline_background : c::child::outline_background, g.IO.DeltaTime * 12.f);

    if (selected) {
        ImGui::GetWindowDrawList()->AddRectFilled(bb.Min, bb.Max, GetColorU32(it_anim->second.background), c::button::rounding);
        ImGui::GetWindowDrawList()->AddRect(bb.Min, bb.Max, GetColorU32(it_anim->second.image), c::button::rounding);

        GetWindowDrawList()->AddShadowRect(bb.Min, bb.Max, GetColorU32(it_anim->second.image), 70, ImVec2(0, 0), 35, 70);
    ...
    GetWindowDrawList()->AddRectFilled(bb.Min, bb.Max, GetColorU32(c::checkbox::background), c::button::rounding);
    GetWindowDrawList()->AddRect(bb.Min, bb.Max, GetColorU32(c::checkbox::outline_background), c::button::rounding);

    //   }

      // ImGui::GetWindowDrawList()->AddRectFilledMultiColorRounded(bb.Min, bb.Max, ImColor(c::child::background), ImColor(c::menu_sett::menu_color_swither.Value.x, c::menu_sett::menu_color_swither.Value.y, c::menu_sett::menu_color_swither.Value.z, 0.055f), ImColor(c::menu_sett::menu_color_swither.Value.x, c::menu_sett::menu_color_swither.Value.y, c::menu_sett::menu_color_swither.Value.z, 0.f), ImColor(c::menu_sett::menu_color_swither.Value.x, c::menu_sett::menu_color_swither.Value.y, c::menu_sett::menu_color_swither.Value.z, 0.f), ImColor(c::menu_sett::menu_color_swither.Value.x, c::menu_sett::menu_color_swither.Value.y, c::menu_sett::menu_color_swither.Value.z, 0.055f), 4.0f, ImDrawCornerFlags_TopLeft);
    PushStyleColor(ImGuiCol_Text, GetColorU32(it_anim->second.text));



    if (label == "Misc") {
        RenderTextClipped(bb.Min + ImVec2(25, 45), bb.Max, label, NULL, &label_size, ImVec2(0.0f, 0.0f), &bb);
    }
    else {
        RenderTextClipped(bb.Min + ImVec2(15, 45), bb.Max, label, NULL, &label_size, ImVec2(0.0f, 0.0f), &bb);
    }
    PopStyleColor(1);
    if (number == "1") {
    ...
    //RenderTextClipped(bb.Min + ImVec2(60, 10), bb.Max - ImVec2(0, 10), hint, NULL, &label_size, ImVec2(0.0f, 1.0f), &bb);
    //PopStyleColor(1);
...
struct button_state
{
    ImVec4 background, text, othern, button;
};
...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    it_anim->second.background = ImLerp(it_anim->second.background, IsItemActive() ? ImVec4(c::menu_sett::menu_color_swither.Value.x, c::menu_sett::menu_color_swither.Value.y, c::menu_sett::menu_color_swither.Value.z, 1.f) : c::checkbox::background, g.IO.DeltaTime * 6.f);
    it_anim->second.text = ImLerp(it_anim->second.text, IsItemActive() ? ImVec4(c::menu_sett::menu_color_swither.Value.x, c::menu_sett::menu_color_swither.Value.y, c::menu_sett::menu_color_swither.Value.z, 1.f) : c::text::text, g.IO.DeltaTime * 6.f);
    it_anim->second.othern = ImLerp(it_anim->second.othern, IsItemActive() ? ImVec4(c::menu_sett::menu_color_swither.Value.x, c::menu_sett::menu_color_swither.Value.y, c::menu_sett::menu_color_swither.Value.z, 0.3f) : c::checkbox::outline_background, g.IO.DeltaTime * 6.f);
    ...
    GetWindowDrawList()->AddRectFilled(bb.Min, bb.Max, GetColorU32(c::checkbox::background), 4);
    GetWindowDrawList()->AddRect(bb.Min, bb.Max, GetColorU32(c::checkbox::outline_background), 4);


    // if (IsItemActive()) {
         //ImGui::GetWindowDrawList()->AddShadowRect(bb.Min, bb.Max, GetColorU32(it_anim->second.background), 20, ImVec2(0, 0), 15, 30);
    GetWindowDrawList()->AddRect(bb.Min, bb.Max, GetColorU32(it_anim->second.othern), 4);
...
struct check_state {
    ImVec4  circle, text, circle_color;
    float move;
    ImVec4 alpha_v;
};

bool ImGui::Checkbox(const char* label, bool* v, const char* TextDisc)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
    ...
    const ImVec2 pos = window->DC.CursorPos;
    const ImRect total_bb(pos, pos + ImVec2(w + square_sz + 10, label_size.y + 35));
    ...
    it_anim->second.circle = ImLerp(it_anim->second.circle, *v ? ImVec4(c::menu_sett::menu_color_swither.Value.x, c::menu_sett::menu_color_swither.Value.y, c::menu_sett::menu_color_swither.Value.z, 0.5f) : c::text::text_colocl, g.IO.DeltaTime * 6.f);
    it_anim->second.circle_color = ImLerp(it_anim->second.circle_color, *v ? ImVec4(c::menu_sett::menu_color_swither.Value.x, c::menu_sett::menu_color_swither.Value.y, c::menu_sett::menu_color_swither.Value.z, 255.f) : ImVec4(c::text::text.x, c::text::text.y, c::text::text.z, 0), g.IO.DeltaTime * 6.f);
    ...
    it_anim->second.text = ImLerp(it_anim->second.text, *v ? c::accent_text_color : c::text::text, g.IO.DeltaTime * 6.f);
    it_anim->second.move = ImLerp(it_anim->second.move, *v ? 9.f : -12.f, g.IO.DeltaTime * 6.f);
    it_anim->second.alpha_v = ImLerp(it_anim->second.alpha_v, *v ? ImVec4(c::menu_sett::menu_color_swither.Value.x, c::menu_sett::menu_color_swither.Value.y, c::menu_sett::menu_color_swither.Value.z, 0.3f) : ImVec4(c::menu_sett::menu_color_swither.Value.x, c::menu_sett::menu_color_swither.Value.y, c::menu_sett::menu_color_swither.Value.z, 0.f), g.IO.DeltaTime * 6.f);
    ...
    if (TextDisc != "") {
        GetWindowDrawList()->AddText(ImVec2(check_bb.Max.x - square_sz + 10, check_bb.Min.y + 27), GetColorU32(c::text::text), TextDisc);
    }
    GetWindowDrawList()->AddRectFilled(total_bb.Min, total_bb.Max, GetColorU32(c::checkbox::background), 4);
    GetWindowDrawList()->AddRect(total_bb.Min, total_bb.Max, GetColorU32(c::checkbox::outline_background), 4);

    //  GetWindowDrawList()->AddRectFilledMultiColorRounded(total_bb.Max, total_bb.Min + ImVec2(50, 0), ImColor(c::checkbox::background), ImColor(it_anim->second.alpha_v), ImColor(c::menu_sett::menu_color_swither.Value.x, c::menu_sett::menu_color_swither.Value.y, c::menu_sett::menu_color_swither.Value.z, 0.f), ImColor(c::menu_sett::menu_color_swither.Value.x, c::menu_sett::menu_color_swither.Value.y, c::menu_sett::menu_color_swither.Value.z, 0.f), ImColor(it_anim->second.alpha_v), 4.0f, ImDrawCornerFlags_TopLeft);




   //   GetWindowDrawList()->AddRectFilled(check_bb.Min + ImVec2(w - 1, 0), check_bb.Max + ImVec2(w, 0), GetColorU32(c::checkbox::background), 1);
   GetWindowDrawList()->AddRectFilled(check_bb.Min + ImVec2(w - 1, 16), check_bb.Max + ImVec2(w, 16), GetColorU32(it_anim->second.circle), 1);
 
    
    
    //GetWindowDrawList()->AddShadowRect(check_bb.Min + ImVec2(w - 1, 16), check_bb.Max + ImVec2(w, 16), GetColorU32(it_anim->second.circle), 20, ImVec2(0, 0), 15, 20);



    // GetWindowDrawList()->AddRectFilled(check_bb.Min + ImVec2(w - 1, 16), check_bb.Max + ImVec2(w, 16), GetColorU32(it_anim->second.circle_color), 1);



    RenderCheckMark(window->DrawList, check_bb.Min + ImVec2(w + 3, 16 + 3), ImColor(1.f, 1.f, 1.f, it_anim->second.move), 11.f);
    ...
    if (TextDisc != "") {
        GetWindowDrawList()->AddText(ImVec2(check_bb.Max.x - square_sz + 10, check_bb.Min.y + 8), GetColorU32(it_anim->second.text), label);

    }
    else if (TextDisc == "") {
        GetWindowDrawList()->AddText(ImVec2(check_bb.Max.x - square_sz + 10, check_bb.Min.y + 17), GetColorU32(it_anim->second.text), label);
    }
...
{
    //SetCursorPos(GetCursorPos() + ImVec2(250 - 320, 20));
    //ImGui::ColorEdit4(label_picker, col, ImGuiColorEditFlags_NoSidePreview | ImGuiColorEditFlags_AlphaBar | ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_AlphaPreview | ImGuiColorEditFlags_NoLabel);
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    const ImRect bb(window->DC.CursorPos + ImVec2(110, +16), window->DC.CursorPos + ImVec2(w + square_sz + 10, label_size.y + 18));

    const ImVec2 label_sizeqw = CalcTextSize(preview_value, NULL, true);
    /* const float square_sz = 19.f, w = GetContentRegionMax().x - style.WindowPadding.x - square_sz;
     const ImVec2 pos = window->DC.CursorPos;
     const ImRect total_bb(pos, pos + ImVec2(w + square_sz + 10, label_size.y + 35));*/

    const ImRect bb_rect(window->DC.CursorPos, window->DC.CursorPos + ImVec2(w + square_sz + 10, label_size.y + 35));

    const ImRect total_bb(bb.Min, bb.Max + ImVec2(label_size.x, 35));
    ItemSize(total_bb, 0);
    ...
    GetWindowDrawList()->AddRectFilled(bb_rect.Min, bb_rect.Max, GetColorU32(c::checkbox::background), 4);
    GetWindowDrawList()->AddRect(bb_rect.Min, bb_rect.Max, GetColorU32(c::checkbox::outline_background), 4);
    ...
    //  GetWindowDrawList()->AddRectFilled(bb.Min, ImVec2(bb.Min.x + (w - 100), bb.Max.y), GetColorU32(it_anim->second.combo), 4);
    GetWindowDrawList()->AddShadowRect(bb.Min, ImVec2(bb.Min.x + (w - 100), bb.Max.y), GetColorU32(it_anim->second.combo), 20, ImVec2(0, 0), 15, 30);
    ...
    GetWindowDrawList()->AddText(ImVec2(bb_rect.Max.x - w - 15, bb.Min.y), GetColorU32(c::accent_text_color), label);
...
bool ImGui::BeginComboPopup(ImGuiID popup_id, const ImRect& bb, ImGuiComboFlags flags)
{
    ...
    if (ImGuiWindow* popup_window = FindWindowByName(name))
        if (popup_window->WasActive)
        {
            ...
            SetNextWindowPos(pos + ImVec2(-10, 4));
        }
    ...
    PushStyleColor(ImGuiCol_PopupBg, GetColorU32(ImVec4(c::child::background.x, c::child::background.y, c::child::background.z, c::child::background.w + 0.5)));
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    const ImRect frame_bb(window->DC.CursorPos + ImVec2(0, 25), window->DC.CursorPos + ImVec2(w + 10, label_size.y + 25));
    const ImRect slider_bb(window->DC.CursorPos + ImVec2(20, 25), window->DC.CursorPos + ImVec2(w - 50, label_size.y + 25));
    ...
    it_anim->second.combo_col = ImLerp(it_anim->second.combo_col, IsItemActive() ? ImVec4(c::menu_sett::menu_color_swither.Value.x, c::menu_sett::menu_color_swither.Value.y, c::menu_sett::menu_color_swither.Value.z, 255.f) : hovered ? ImVec4(c::menu_sett::menu_color_swither.Value.x, c::menu_sett::menu_color_swither.Value.y, c::menu_sett::menu_color_swither.Value.z, 255.f / 2) : c::text::text, g.IO.DeltaTime * 6.f);
    ...
    if (grab_bb.Max.x > grab_bb.Min.x) {
        ...
        GetWindowDrawList()->AddCircleFilled(ImVec2(frame_bb.Min.x + it_anim->second.slow + 2, grab_bb.Max.y - 7.5), 5.5f, GetColorU32(it_anim->second.combo_col), 30.f);
        GetWindowDrawList()->AddCircle(ImVec2(frame_bb.Min.x + it_anim->second.slow + 2, grab_bb.Max.y - 7.5), 6.f, GetColorU32(c::checkbox::outline_background), 30.f);




        GetWindowDrawList()->AddShadowCircle(ImVec2(frame_bb.Min.x + it_anim->second.slow + 2, grab_bb.Max.y - 7.5), 6.f, GetColorU32(it_anim->second.combo_col), 50.f, ImVec2(0, 0), 0, 12);
    ...
    RenderTextClipped(frame_bb.Max - ImVec2(70, 20), frame_bb.Max + ImVec2(20, 4), value_buf, value_buf_end, NULL, ImVec2(0.5f, 0.5f));
    PopStyleColor();
    PopFont();


    GetWindowDrawList()->AddText(ImVec2(total_bb.Max.x - w - 10, total_bb.Min.y + 5), GetColorU32(c::accent_text_color), label);
...
bool ImGui::InputText(const char* label, char* buf, size_t buf_size, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* user_data, ImVec2 size_arg)
{
...
bool ImGui::Selectable(const char* label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
    ...
    it_anim->second.text = ImLerp(it_anim->second.text, selected ? ImVec4(c::menu_sett::menu_color_swither.Value.x, c::menu_sett::menu_color_swither.Value.y, c::menu_sett::menu_color_swither.Value.z, 0.7f) : hovered ? c::text::text_hov : c::text::text, g.IO.DeltaTime * 6.f);
