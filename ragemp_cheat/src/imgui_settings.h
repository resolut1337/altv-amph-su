...
{
	namespace menu_sett {
		inline ImColor menu_color_swither = ImColor(165, 0, 255, 255);
	}
	...
	namespace checkbox
	{
		...
		inline ImVec4 background = ImColor(0, 0, 0, 80);
	...
	{
		inline ImVec4 background = ImColor(27, 29, 32, 255);
		inline ImVec4 outline_background = ImColor(30, 32, 36, 170);
