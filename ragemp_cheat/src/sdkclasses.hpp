...
//	static auto GetName = (GetName_t)(MemoryRRR::PatternScan(("40 53 48 83 EC ? 80 3D ? ? ? ? ? 8B D9 74 ? 33 D2"), NULL, NULL));
...
public:
	...
	{
		if (!this) return 0;
		return *(int32_t*)(this + 0x20) = value;
	}
	int32_t  SetAmmoExplosiveType(float value)
	{
		if (!this) return 0;
		return *(int32_t*)(this + 0x24) = value;
	}
...
public:
	...
	{
		if (!this) return Vector4{ 0.f,0.f,0.f,0.f };
		return *(Vector4*)(this + 0x30) = Coords;
	}
	Quaternion GetRotation()
	{
		if (!this) return Quaternion{ 0.f,0.f,0.f,0.f };
		return *(Quaternion*)(this + 0x30);
	}
};
...
public:
	...
	{
		if (!this) return 0;
		return *(float*)(this + 0x004C) = Health;
	}
...
public:
	...
	{
		if (!this) return 0;
		return (hk_VehicleHandlingInfo*)(*(uint64_t*)(this + 0x0960));
	}
	Vector3 GetCoordinate()
	{
		if (!this) return Vector3{ 0,0,0 };
	...
	{
		if (!this) return 0;
		return *(float*)(this + 0x0C8C) = Health; // old 0x0C3C
	}
...
public:
	...
	{
		if (!this) return 0;
		return (hk_PlayerInfo*)(*(uint64_t*)(this + 0x10A8));
	}
	hk_WeaponManager* WeaponManager()
	{
		if (!this) return 0;
		return (hk_WeaponManager*)(*(uint64_t*)(this + 0x10B8));
	}
	...
	{
		if (!this) return 0;
		return (hk_Vehicle*)(*(uint64_t*)(this + 0x0D10));
	}
	...
	{
		if (!this) return 0;
		return *(float*)(this + 0x150C) = Armor;
	}
	float SetMaxHealth()
	{
		if (!this) return 0;
...
public:
	...
	{
		if (!this) return 0;
		return (hk_PedList*)(*(uint64_t*)(this + 0x158));
	}
	...
	hk_Ped* get_ped(const int& index)
	{
		if (index < this->PedMaximum())
			return this->PedList()->Ped(index);
		return nullptr;
	}
};
...
public:
	...
	hk_PedInterface* ObjectInterface()
	{
		if (!this) return 0;
		return (hk_PedInterface*)(*(uint64_t*)(this + 0x28));
	}
